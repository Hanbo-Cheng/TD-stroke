...
# last_saveto = work_path+'results_test'+'/WAP_params_last.pkl'
last_saveto = work_path+'compare_model'+'/WAP_params_uni_1.pkl'
...
train_dataIterator = BatchBucket(600*2, 2100*2, 200*2, 800000*2, 32,  #batch size 
