...
class DenseNet(nn.Module):
    def __init__(self, inChannels,growthRate, reduction, bottleneck, use_dropout):
        super(DenseNet, self).__init__()
        nDenseBlocks = 22
        nChannels = 2 * growthRate
        self.conv1 = nn.Conv2d(inChannels, nChannels, kernel_size=7, padding=3, stride=2, bias=False)
